...
<head>
    ...
    <title>Dashboard &mdash; Villa Melati Garden</title>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">Villa Melati Garden</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @can('galleries.index')
                            ...
                            href="{{ route('admin.gallery.index') }}"><i class="fas fa-image"></i>
                        ...
                        @can('bookings.index')
                        <li class="{{ setActive('admin/booking') }}"><a class="nav-link"
                                href="{{ route('admin.booking.index') }}"><i class="fas fa-bell"></i>
                                <span>Booking</span></a></li>
                        @endcan

                        {{-- @can('bookings.index')
                        <li class="{{ setActive('admin/tag') }}"><a class="nav-link"
                                href="#"><i class="fas fa-tags"></i> <span>Booking</span></a>
                        </li>
                        @endcan
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2023 <div class="bullet"></div> Villa Melati Garden <div class="bullet"></div> All Rights
                    Reserved.
                </div>
